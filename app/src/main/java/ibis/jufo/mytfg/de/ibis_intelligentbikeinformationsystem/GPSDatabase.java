...
public class GPSDatabase {
    ...
    public final String CREATERDB="create table GPSData(Id integer primary key autoincrement,latitude text not null, longitude text not null, altitude text not null, timestamp text not null);";
