...
public class MainActivity extends AppCompatActivity {
    ...
    public void onClickStartTracking(View view) {
        if (OcycoApplication.isCollect_data()) {
            enableButtons();
    ...
    private void enableButtons() {
        ...
        start_tracking_button.setEnabled(!OcycoApplication.isOnline_tracking_running());
        stop_tracking_button.setEnabled(OcycoApplication.isOnline_tracking_running());
    }
